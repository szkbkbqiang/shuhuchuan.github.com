...
<script src="http://res.wx.qq.com/open/js/jweixin-1.2.0.js"></script>
  ...
  <div id="box">
    ...
    <div id="vjs">
     <video id="my-video" class="video-js vjs-big-play-centered vjs-default-skin" controls preload="auto" height="320">
  ...
  <script>
    ...
    setTimeout(function () {
      ...
      $('#vjs').show(200)
      var myPlayer = videojs('my-video');
      $('#my-video').css({width: $(window).width(), height: $(window).height()})
      videojs("my-video").ready(function(){
        var myPlayer = this;
        myPlayer.play();
      });      
