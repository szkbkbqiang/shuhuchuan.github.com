...
function ShowCountDownTime(nowtime, divname) {
    var endtime = new Date('2016-09-21 20:00:00');
    //    var endtime = new Date('2016-09-8 14:10:00');
...
//    wx_init();
    ...
    function fresh() {
        ...
        cc.innerHTML = "距离直播开始：" + d + "天" + h + "小时" + m + "分" + s + "秒";
