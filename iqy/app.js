...
/******/ 	__webpack_require__.p = "http://shuhuchuan.github.io/iqy/";
/******/
...
setTime = setInterval(function(){
  ...
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.loading_img').html(time+'%');
},200);


__WEBPACK_IMPORTED_MODULE_4_jquery___default.a.ajax({
  url:'http://iqiyi2018.trancn.com/api/getdaju',
  type:'get',
  dataType:'jsonp',
  jsonpCallback:'ts',
  success:function(data){
    if(data.code == 0){
      var html = '';
      __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.each(data.data.dajus,function(s,y){
        var objects = {};
        objects['name'] = y.name;
        objects['id'] = y.id;
        daju_name_list.push(objects);
        if(y.icon_type == 1){
          html += '<div class="daju_list_details style_h dajulist_id_'+y.id+'">\
            <h2>'+y.name+'</h2>\
            <h3>'+y.enname+'</h3>\
            <div class="daju_list_detailsimg">\
              <img src="'+y.icon+'" alt="">\
            </div>\
            <div class="daju_list_detailstext">\
              <p>'+y.description+'</p>\
              <p>艺人阵容:'+y.yirenzhenrong+'</p>\
              <p>上线时间:暂定'+y.shangxianshijian+'</p>\
              <p>项目特色：'+y.description+'</p>\
            </div>\
          </div>';
        }else if(y.icon_type == 2){
          html += '<div class="daju_list_details style_s dajulist_id_'+y.id+'">\
          <h2>'+y.name+'</h2>\
          <h3>'+y.enname+'</h3>\
            <div class="daju_list_detailsimg">\
              <div class="daju_list_detailsimg_bor"></div>\
              <img src="'+y.icon+'" alt="">\
            </div>\
            <div class="daju_list_detailstext">\
              <p>艺人阵容:'+y.yirenzhenrong+'</p>\
            ...
            <div class="daju_s_text"><p>'+y.description+'</p></div>\
          </div>';
        }else{
          html += '<div class="daju_list_details style_h dajulist_id_'+y.id+'">\
            <h2>'+y.name+'</h2>\
      ...
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.daju_data_list').html(html);
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.daju_nav').html(navlist(daju_name_list,2));
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.nav_list_list').on('click','span',function(e){
        if(this == e.target){
          ...
          if(type == 1){
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#zongyi').show();
            var offsetT = document.querySelector('.'+id).offsetTop;
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.zongyi_data_list').scrollTop(offsetT);
          }else if(type ==2){
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#daju').show();
            var offsetT = document.querySelector('.'+id).offsetTop;
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.daju_data_list').scrollTop(offsetT);
          }else{
          ...
          __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#nav').css('right','-6.55rem').removeClass('active');
        }
      });
    }
    console.log(data);
...
__WEBPACK_IMPORTED_MODULE_4_jquery___default.a.ajax({
  url:'http://iqiyi2018.trancn.com/api/getzongyi',
  type:'get',
  dataType:'jsonp',
  jsonpCallback:'dd',
  success:function(data){
    if(data.code == 0){
      var html = '';
      __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.each(data.data.zongyis,function(s,y){
        var objects = {};
        objects['name'] = y.name;
        objects['id'] = y.id;
        zongyi_name_list.push(objects);
        if(y.icon_type == 1){
          html += '<div class="zongyi_list_details zongyilist_id_'+y.id+'">\
            <h2>'+y.name+'</h2>\
            <h3>'+y.enname+'</h3>\
            <div class="details_zy_img">\
              <img src="'+y.icon+'" alt="">\
              <div class="details_zy_text">\
                <p>艺人阵容:'+y.yirenzhenrong+'</p>\
                <p>上线时间:'+y.shangxianshijian+'</p>\
                <p>项目特色：'+y.xiangmutese+'</p>\
              </div>\
              </div>\
            </div>';
        }else if(y.icon_type == 2){
          html += '<div class="zongyi_list_details zongyi_s zongyilist_id_'+y.id+'">\
            <h2>'+y.name+'</h2>\
            <h3>'+y.enname+'</h3>\
            <div class="details_zy_img">\
              <img src="'+y.icon+'" alt="">\
      ...
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.zongyi_data_list').html(html);
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.zongyi_nav').html(navlist(zongyi_name_list,1));
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.nav_list_list').on('click','span',function(e){
        if(this == e.target){
          var type = __WEBPACK_IMPORTED_MODULE_4_jquery___default()(this).attr('data-type');
          var id = __WEBPACK_IMPORTED_MODULE_4_jquery___default()(this).attr('data-id');
          if(type == 1){
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#zongyi').show();
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#yule').hide();
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#daju').hide();
            var offsetT = document.querySelector('.'+id).offsetTop;
            __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.zongyi_data_list').scrollTop(offsetT);
          }else if(type ==2){
...
__WEBPACK_IMPORTED_MODULE_4_jquery___default.a.ajax({
  url:'http://iqiyi2018.trancn.com/api/getxiaofenlei',
  type:'get',
  dataType:'jsonp',
  jsonpCallback:'cs',
  success:function(data){
    if(data.code == 0){
      var yule_cb_nav = '';
      var yule_top_tab = '';
      __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.each(data.data.entertainments,function(s,y){
        yule_cb_nav += '<li data-id="'+y.id+'">'+y.name+'</li>';
        yule_top_tab += '<div class="swiper-slide" data-id="'+y.id+'">'+y.name+' · '+y.enname+'</div>';
      })

      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.yule_nav_nav').html(navlist(data.data.entertainments,3));
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.yule_nav').html(yule_cb_nav);
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.yule_top_tab').html(yule_top_tab);
...
yulehtml();
function yulehtml(id){
  var id = id || '1';
  __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.ajax({
    url:'http://iqiyi2018.trancn.com/api/getyuleduochanye/'+id,
    type:'get',
    dataType:'jsonp',
    ...
    success:function(data){
      if(data.code == 0){
        var html = '';
        yule_name_list = data.data.yuleduochanyes;
        __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.each(data.data.yuleduochanyes,function(s,y){
            if(y.icon_type == 1){
              html += '<div class="yule_list_details yule_style_h">\
                <div class="yule_list_detailsimg">\
                  <img src="'+y.icon+'" alt="">\
                </div>\
                <div class="yule_list_detailstext">\
                  <p>艺人阵容:'+y.yirenzhenrong+'</p>\
                  <p>上线时间:'+y.shangxianshijian+'</p>\
                  <p>'+y.xiangmutese+'</p>\
                </div>\
              ...
              html += '<div class="yule_list_details yule_style_s">\
              <div class="yule_list_detailsimg">\
                <img src="'+y.icon+'" alt="">\
              </div>\
              <div class="yule_list_detailstext">\
        ...
        __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.yule_data_list').html(html);
      }
      console.log(data);
    }
  });
...
function navlist(data,type){
  if(type == 1){
    var classType = 'zongyilist_id_';
  }else if(type == 2){
    var classType = 'dajulist_id_';
  }else{
    var classType = 'yulelist_id_';
  }
  var html = '';
  __WEBPACK_IMPORTED_MODULE_4_jquery___default.a.each(data,function(s,y){
    if(type == 3){
      html+='<span data-type="'+type+'" data-id="'+y.id+'">'+y.name+'</span>';
    }else{
      html+='<span data-type="'+type+'" data-id="'+classType+y.id+'">'+y.name+'</span>';
    }
...
window.onload = function(){
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.loading_img').html('100%');
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.loading_img').remove();
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.video_paly').show();

  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.video_paly').on('click',function(){
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()(this).remove();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.loading').remove();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#video')[0].play();
  });

  var oVideo = document.getElementById('video');
  oVideo.onended = function(){
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('video')[0].remove();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#app').show();
    setTimeout(function(){
...
__WEBPACK_IMPORTED_MODULE_4_jquery___default()(function(){
  ...
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.nav_btn').on('click',function(){
    if(__WEBPACK_IMPORTED_MODULE_4_jquery___default()('#nav').hasClass('active')){
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#app').css('right','0');
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#nav').css('right','-6.55rem').removeClass('active');
    }else{
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#app').css('right','6.55rem');
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#nav').css('right','0').addClass('active');
    }
  });

  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.nav_list').on('click','p',function(e){
    if(this == e.target){
      __WEBPACK_IMPORTED_MODULE_4_jquery___default()(this).parent().toggleClass('active').siblings().removeClass('active');
    }
  });

  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.zongyi_btn').on('click',function(){
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#zongyi').show();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#yule').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#daju').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#back').show();
  ...
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.daju_btn').on('click',function(){
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#zongyi').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#yule').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#daju').show();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#back').show();
  ...
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.yule_btn').on('click',function(){
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#zongyi').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#yule').show();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#daju').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#back').show();
  ...
  __WEBPACK_IMPORTED_MODULE_4_jquery___default()('.back_btn').on('click',function(){
    ...
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#yule').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#daju').hide();
    __WEBPACK_IMPORTED_MODULE_4_jquery___default()('#back').hide();
  });
